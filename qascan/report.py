...
<div class="wrap">
  ...
  {sections_html}
  <footer><strong>qascan</strong> · oracle-free web QA scanner · exploratory + accessibility<br>
    <span style="color:#9ca3af">Info / unverified items (e.g. rate-limited links) are surfaced
    for transparency, not counted as failures.</span></footer>
</div>
</body>
</html>
"""
